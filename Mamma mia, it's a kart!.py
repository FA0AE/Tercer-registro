...
'Función que dibuja la pantalla con el puntaje'
...
def dibujarJuego():
    ...
    imagen = [
        ...
        pygame.image.load("salidaUno.png"),
        pygame.image.load("salidaDos.png"),
        ...
        if estadoJuego == MENU:
            ...
            if y < yMoneda + altoMoneda:
                if x > xMoneda and x < xMoneda + anchoMoneda or x + anchoImagen > xMoneda and x + anchoImagen < xMoneda + anchoMoneda:
                    puntos = 0                                     #Se crea un contador para los puntos
                    ...
                    puntos += monedasColectadas                    #Puntos actualizados
